          ...
          <tbody>
            {data.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                  {item.group_name === "Science" ? item.boys + item.girls : ""}
                </td>
                <td>
                  {item.group_name === "Commerce" ? item.boys + item.girls : ""}
                </td>
                <td>
                  {item.group_name === "Humanities"
                ...
                if (
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>{item.section_name}</td>
                      <td>
                        {item.group_name === "Science"
                          ? item.boys + item.girls
                          : ""}
                      </td>
                      <td>
                        {item.group_name === "Commerce"
                          ? item.boys + item.girls
                          : ""}
                      </td>
                      <td>
