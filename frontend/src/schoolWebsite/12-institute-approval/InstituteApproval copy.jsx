    ...
    useEffect(() => {
      axios
        .get(`${apiUrl}/approvals/${instituteCode}/`, {
          params: { institute: instituteCode },
        })
        .then((res) => {
      ...
      <div className="max-w-6xl mx-auto p-6 min-h-screen">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center items-center space-x-2 text-green-600">
            ...
            <span className="font-medium">সরকারি কর্তৃপক্ষ কর্তৃক অনুমোদিত প্রতিষ্ঠান</span>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                <h3 className="text-lg font-medium text-gray-800">প্রতিষ্ঠানের নাম</h3>
                <p className="text-gray-600 font-semibold">{certificateData.instituteName}</p>
                <p className="text-gray-500 text-sm">{certificateData.instituteNameEn}</p>
              </div>
              ...
              <div className="grid gap-4">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">শিক্ষা প্রতিষ্ঠান সনাক্তকরণ নম্বর</p>
                    <p className="text-gray-600">{certificateData.approvalNumber}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">জারির তারিখ</p>
                    <p className="text-gray-600">{certificateData.issueDate}</p>
                    <p className="text-gray-500 text-sm">{certificateData.issueDateEn}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">প্রদানকারী কর্তৃপক্ষ</p>
                    <p className="text-gray-600">{certificateData.issuingAuthority}</p>
                    <p className="text-gray-500 text-sm">{certificateData.issuingAuthorityEn}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h4 className="font-medium text-green-800">যাচাইকৃত সার্টিফিকেট</h4>
                </div>
