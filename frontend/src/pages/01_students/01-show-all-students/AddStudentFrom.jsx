    ...
    reader.onload = (e) => {
      ...
      const studentsFromCSV = rows.slice(1).map((row) => {
        ...
        row.forEach((value, index) => {
          ...
          else if (key === "name bangla") student.roll_number = val;
          else if (key === "roll") student.roll_number = val;
          else if (key === "nid") student.roll_number = val;
          else if (key === "fathers name") student.roll_number = val;
          else if (key === "mothers name") student.roll_number = val;
