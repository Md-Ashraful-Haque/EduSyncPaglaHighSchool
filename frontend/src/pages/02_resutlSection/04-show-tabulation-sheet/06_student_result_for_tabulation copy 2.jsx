...
const StudentResultForTabulation = ({ singleMarksheetForStudent, indexForColor }) => {
        ...
        <React.Fragment key={index}>
          ...
          {subject.marks.length === 1 ? (
            ...
            <td>
              ...
              <span
                className={` ${
                  subject.grade_and_point[1] == 0 && subject.total_marks > -1? "underline bg-red-100 text-red-600 rounded-lg p-1"
                    : ""
                } `}
              > 
