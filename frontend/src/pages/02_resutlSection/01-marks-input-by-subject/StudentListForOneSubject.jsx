        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <h3 className="text-lg text-center font-semibold text-gray-800 mb-3">
              সমষ্টিগত নম্বর প্রয়োগ নিশ্চিতকরণ
            </h3>
            ...
            <div className="marks-entry-for-one-subject">
              <div className="container-fluid overflow-auto">
                <div className="row flex-nowrap !min-w-[574px]">
                  ...
                  {/* <button onClick={() => setAllMarks("CA", 45)}>
                    Apply to all (MCQ)
                  </button> */}
                        ...
                        <div className="col-2" key={type.id}>
                          {/* <div className="heading">
                            ...
                            <input
                              ...
                              onChange={(e) =>{
                                // setAllMarks(type.mark_type, type.max_marks);
                                handleBulkToggle(type.mark_type,type.max_marks, e.target.checked);
                              }
                              }
                            />
                          </div> */}
                          <div className="heading flex items-center justify-between gap-3 py-2">
