...
const MarksheetTableBody = ({ singleMarksheetForStudent, highest_marks,instituteLogo }) => {
  ...
  const getHighestMarkData = (subjectId) => {
    return highest_marks?.find(item => item.subject === subjectId);
  };
          ...
          subject.total_marks > -1 && (
            ...
            >
              ...
              >
                ...
                {highest_marks?.[index] ? (
                  <>
                    {bySubjectVars.isBangla ? showBangla(highest_marks[index].highest_marks) : highest_marks[index].highest_marks}{" "}
                    (
                    {bySubjectVars.isBangla ? highest_marks[index].section_name_display : highest_marks[index].section_name},{" "}
                    {bySubjectVars.isBangla ? showBangla(highest_marks[index].roll) : highest_marks[index].roll}
                    )- {highest_marks[index].subject}
                  </>
                ) : (
