...
const MarksheetTableBody = ({
  ...
  const calculatePairTotalMarks = (
    ...
    const relevantSubjects = subjects.filter(
      (subject) =>
        subject.subject_name === firstPaperName ||
        subject.subject_name === secondPaperName ||
        subject.subject_name_bangla === firstPaperName ||
        subject.subject_name_bangla === secondPaperName
    );
  ...
  const isFirstPaper = (subject) => {
    // console.log("Subject Code: ",subject.subject_code);
    return (
      subject.subject_code === "g-91001" ||
      subject.subject_code === "g-91003"
            ...
            >
              ...
              {["WR", "MCQ", "Practical"].map((type) => {
                ...
                if (
                  ...
                  if (
                    (subject.subject_name?.includes("Bangla") ||
                      subject.subject_name_bangla?.includes("বাংলা")) &&
                  ...
                  // Check if this is English and needs adjustment
                    ...
                    (subject.subject_name?.includes("English") ||
                      subject.subject_name_bangla?.includes("ইংরেজি")) &&
