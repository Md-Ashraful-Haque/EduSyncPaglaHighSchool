...
const CreateExamRoutine = () => {
    ...
    const loadSubjects = async () => {
      if ( 
        ...
        try {
          ...
          setSelectedSubjects([]);
          toast.error("setSelectedSubjects.");
          ...
          setIsLoading(false);
          toast.error("Final Step.");
          console.log("finally");
        }

        console.log("Change Values inside if statement");
      }
    };
    console.log( 
        bySubjectVars.year,
  ...
  ///////////////////////////////////////////////////////////////////////////
  // Update row (subject/date/time)
  const updateRoutine = (index, field, value) => {
    const updated = [...routineRows];

    if (field === "subject_id") {
      const oldSub = updated[index].subject_id;
      const newSub = value;
      ...
      // Maintain selected subject list
