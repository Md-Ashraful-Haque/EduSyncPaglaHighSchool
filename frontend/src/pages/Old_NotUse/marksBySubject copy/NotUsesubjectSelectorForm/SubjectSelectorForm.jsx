...
import "./subjectSelectorForm.scss";
...
// const fetchData = (createNewAccessToken, endpoint, params) => {
//   // Check if all required params are provided
//   if (!params || Object.values(params).some((value) => !value)) {
//     return Promise.resolve([]); // Return empty array if params are incomplete
//   }

//   // Fetch data from the API and handle errors
//   return fetchFromFieldsData(createNewAccessToken, endpoint, params).catch((error) => {
