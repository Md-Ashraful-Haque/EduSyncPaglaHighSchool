...
const TeacherTableCell = ({ teacher }) => {
    ...
    <>
      <td className="px-2 py-3 border-bottom">
        <div className="flex items-center space-x-3">
          ...
          <img
            src={teacher.picture || manPlaceHolderImage}
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <img
              src={teacher.picture_cropped_url || manPlaceHolderImage }
              alt={`${teacher.name}'s full profile`}
...
export default TeacherTableCell; 