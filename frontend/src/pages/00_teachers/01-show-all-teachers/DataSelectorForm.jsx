                    ...
                    <div className="inline-flex bg-white rounded-xl border border-gray-100 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-semibold text-xs lg:text-sm "> ডাউনলোড করুন </span>
                        </div>
                      </button> */}
                      ...
                      {/* <button 
                        ...
                        // disabled={!vars.is_staff}
                        className="group flex items-center px-3 sm:px-3 py-2 text-sm font-medium text-gray-700 hover:text-purple-700 hover:bg-purple-100 hover:from-blue-500 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                      >
                        <div className="flex items-center space-x-3">
                          <div className="border border-purple-700 rounded-full p-1.5 group-hover:border-white group-hover:bg-white/20 transition-all duration-300">
