...
export const generatePDFLegal = async (containerClass = 'result-list-container', marksheetClass = 'single-marksheet', fileName = 'marksheets.pdf', orientation="portrait", format="a4", w=210, h=297) => {
  try {
    // Get the container
