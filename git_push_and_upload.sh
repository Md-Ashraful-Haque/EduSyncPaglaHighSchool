...
# Function to set production URL[](https://paglahighschool.nexasofts.com/api) as active
set_prod() {
  cat > frontend/.env << EOF
# VITE_API_URL=https://localhost:8017/api
VITE_API_URL=https://paglahighschool.nexasofts.com/api
VITE_INSTITUTE_CODE=PHS
EOF
  echo "Switched to production: VITE_API_URL=https://paglahighschool.nexasofts.com/api"
  # cat frontend/.env
}
