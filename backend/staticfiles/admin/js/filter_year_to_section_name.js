document.addEventListener("DOMContentLoaded", function () {
  ...
  const sectionNameField = document.getElementById("id_section_name");
  ...
  if (groupField) {
    groupField.addEventListener("change", function () {
      ...
      //   const groupId = this.value;
      //   if (sectionNameField) {
      //     fetchSectionsName(instituteId, yearId, classInstanceId, groupId, sectionNameField.value);
      //   }
      //   if (sectionField) {
